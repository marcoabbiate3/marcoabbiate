...
public class MemoryGame {
    ...
    public String generateRandomString(int n) {
        ...
        for (int i = 0; i < n; i++) {
            int randomNumber = uniform(rand, 26);
            Character c = CHARACTERS[randomNumber];
            randomString.append(c);
        }
        return randomString.toString();
        // while(randomString.length() < n) {
        // randomString.append(CHARACTERS[uniform(rand, CHARACTERS.length());]
        // }
    }
    ...
    public void drawFrame(String s) {
        ...
        if (!gameOver) {
            ...
            if (this.playerTurn) {
                StdDraw.text(width/2, this.height - 1, "Type!");
            } else {
                StdDraw.text(width/2, this.height - 1, "Watch!");
            }
            StdDraw.show();
        }
    ...
    public void startGame() {
        ...
        while (!gameOver) {
            ...
            playerTurn = true;
            drawFrame(""); // switch header from "Watch" -> "Type"
